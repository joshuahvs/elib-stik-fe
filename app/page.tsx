...
export default async function Home() {
  ...
  return (
    <main>
      ...
      <div className="bg-[#4b200f] text-white pb-40">
        ...
        <section className="max-w-7xl mx-auto pt-24 px-8">
          <div className="grid grid-cols-2 gap-16 items-start">
            ...
            {/* RIGHT */}
            <div>
              <h3 className="text-xl font-semibold mb-4">Visi & Misi</h3>

              <p className="mb-4 whitespace-pre-line">{data.vision}</p>
      ...
      {/* IMAGE */}
      <div className="bg-[#e7e3df] pt-0 pb-16 flex flex-col items-center">
        <img
          src={data.image_url}
        ...
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="grid grid-cols-3 gap-8">
            <div className="border rounded-lg p-6 shadow-sm">
              ...
              <p className="text-xs text-gray-400 mt-3">8 Mei 2026</p>
            </div>
            ...
            <div className="border rounded-lg p-6 shadow-sm">
              ...
              <p className="text-xs text-gray-400 mt-3">7 Mei 2026</p>
            </div>
            ...
            <div className="border rounded-lg p-6 shadow-sm">
              ...
              <p className="text-xs text-gray-400 mt-3">5 Mei 2026</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-3 gap-10">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-xs text-gray-400">6 Mei 2026</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-xs text-gray-400">4 Mei 2026</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-xs text-gray-400">2 Mei 2026</p>
              </div>
            </div>
          </div>
        </div>
